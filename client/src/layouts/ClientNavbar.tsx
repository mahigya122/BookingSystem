...
const ClientNavbar = () => {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-40 flex h-14 md:h-16 items-center justify-between px-6 md:px-10 bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800">
        {/* LEFT: LOGO */}
