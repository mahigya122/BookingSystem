        ...
        <div className="flex items-center gap-1 px-8 py-4 bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 flex-shrink-0 overflow-x-auto no-scrollbar">
          {tabs.map((tab) => (
            <button
              ...
              className={`flex items-center gap-2.5 px-5 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all whitespace-nowrap ${
                activeTab === tab.id
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative surface-panel rounded-[2rem] overflow-hidden aspect-video">
                                {cabin.location.image_url ? (
                                    <img src={cabin.location.image_url} alt={cabin.location.name} className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110" />
                                ) : (
                        ...
                        {cabin.activities.map((activity) => (
                            <div key={activity.id} className="surface-panel rounded-3xl overflow-hidden group hover:border-cyan-500/30 transition-all">
                                <div className="h-40 relative">
                                    {activity.image_url ? (
                                        <img src={activity.image_url} alt={activity.name} className="h-full w-full object-cover transition-transform group-hover:scale-105" />
                                    ) : (
