...
import { Pencil, MapPin, Plus, Trash2, Home, Search, Loader2, Globe } from "lucide-react";
...
const Locations = () => {
  ...
  return (
    <div className="space-y-8 animate-slide-up pb-12">
      ...
      {isAdding && (
        <div className="card p-6 space-y-6 bg-amber-50/30 dark:bg-amber-900/10 border-amber-100 dark:border-amber-900/20 animate-in slide-in-from-top duration-300">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-1.5">
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-400">Area Name</label>
                <input
          ...
          <div className="flex justify-end pt-2">
            <button onClick={handleAdd} disabled={isCreating} className="btn btn-primary px-8">
                {isCreating ? <Loader2 size={18} className="animate-spin" /> : "Save Location"}
            </button>
          </div>
        </div>
      )}
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-slate-50 dark:bg-slate-900/50 border-b border-slate-100 dark:border-slate-800">
              ...
              <th className="px-6 py-4 text-left text-[10px] font-black uppercase tracking-widest text-slate-400">Cabins</th>
              <th className="px-6 py-4 text-left text-[10px] font-black uppercase tracking-widest text-slate-400">Region</th>
          ...
          <div className="modal-content w-full max-w-xl p-8 space-y-6 animate-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mt-1">Update geographic region</p>
              </div>
