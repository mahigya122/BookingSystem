...
const HeroSection = () => {
    ...
    return (
        <>
            {/* 1. Auto: shows once per session (first visit / refresh) */}
            <PromoBanner
                trigger="auto"
                onCtaClick={handleExplore}
            />

            {/* 2. Login: fires when user logs in */}
            <PromoBanner
                trigger="login"
                triggerKey={loginKey}
                onCtaClick={handleExplore}
            ...
            {/* 3. Logo click: handled in Navbar */}
                ...
                <div className={`relative z-10 ${layoutConfig.container} grid md:grid-cols-2 gap-16 items-center`}>
                    ...
                    <div className="space-y-6">
                        <div className="space-y-1">
                            ...
                            <motion.h1
                                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black leading-[1.1] text-slate-900 dark:text-white tracking-tight flex flex-wrap gap-x-3 gap-y-1"
                                variants={container}
                                initial="hidden"
                                animate="show"
                            >
                        ...
                        <motion.p
                            className="text-slate-500 dark:text-slate-400 text-sm max-w-lg leading-relaxed font-medium"
                    ...
                    >
                        ...
                        <div className="absolute right-0 top-10 w-64 h-80 lg:w-72 lg:h-96 rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white dark:border-slate-800 rotate-3 z-20">
                            <img fetchPriority="high" src="https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=400&q=80" alt="Mountain cabin" className="w-full h-full object-cover" />
                        </div>
