        ...
        >
            <div className="w-full max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-x-8 gap-y-10 md:gap-12 lg:gap-16 mb-8">
                            ...
                            <div className="flex items-center gap-3 pt-1">
                                ...
                                <div className="text-left space-y-0.5">
                                    <div className="flex items-center gap-1.5">
                                        <span className="text-[11px] md:text-[14px] lg:text-[16px] font-black text-slate-300 tracking-wider uppercase">Scan to Review</span>
                    ...
                    {Object.entries(footerLinks).map(([cat, links]) => (
                        <div key={cat} className="space-y-4 col-span-1">
                            <h4 className="text-[10px] md:text-xs lg:text-sm font-black uppercase tracking-[0.35em] text-slate-500">{cat}</h4>
                    ...
                    <div className="col-span-2 md:col-span-1 space-y-4">
                        <h4 className="text-[10px] md:text-xs lg:text-sm font-black uppercase tracking-[0.35em] text-slate-500">Legal</h4>
                        <ul className="space-y-2.5">
                            {[
                ...
                <div className="pt-6 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
                    <p className="text-[10px] md:text-xs lg:text-sm text-slate-500 font-medium order-3 md:order-1">© 2026 CabinHub. All rights reserved.</p>
