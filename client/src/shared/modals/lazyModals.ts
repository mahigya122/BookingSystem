...
export const CheckoutModal = lazy(() => import("../../domains/cabins/pages/CabinDetails/CheckoutModal"));
...
export const ProfileIncompleteModal = lazy(() => import("../../domains/cabins/pages/CabinDetails/ProfileIncompleteModal"));
